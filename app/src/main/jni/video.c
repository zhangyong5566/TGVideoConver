...
JNIEXPORT jint Java_com_example_zhang_tgvideoconver_utils_Utilities_convertVideoFrame(JNIEnv *env, jclass class, jobject src, jobject dest, jint destFormat, jint width, jint height, jint padding, jint swap) {
